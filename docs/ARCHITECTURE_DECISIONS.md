...
0,5%-a (`LOYALTY_POINTS_PER_CURRENCY_UNIT=0.005`), es a beváltott pontok erteke
egy tranzakcioban legfeljebb a rendeles vegosszegenek 0,5%-a lehet
(`LOYALTY_REDEMPTION_MAX_PERCENT_OF_ORDER=0.005`, uj beallitas - lasd
